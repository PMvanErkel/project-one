        ...
        {category === 'weightlifting' && set.type === 'weightlifting' && (
          <>
            ...
            <div className="set-field" style={{ maxWidth: 60 }}>
              ...
              <select value={set.unit} onChange={e => onUpdate({ unit: e.target.value as 'kg' | 'lbs' })}>
        ...
        {category === 'cardio' && set.type === 'cardio' && (
          <>
            ...
            <div className="set-field" style={{ maxWidth: 52 }}>
              <span className={labelClass}>Unit</span>
              <select value={set.distanceUnit ?? 'km'} onChange={e => onUpdate({ distanceUnit: e.target.value as 'km' | 'mi' })}>
